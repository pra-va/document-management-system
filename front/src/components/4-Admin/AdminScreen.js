...
class AdminScreen extends Component {
    constructor(props) {
        super(props);
        this.state = { isUserAdmin: "false", showNewUser: false, showNewGroup: false, showCreateDocType: false };
    }
    ...
    render() {
        return (
            <div>
                ...
                {<NewGroup showNewGroup={this.state.showNewGroup} hideNewGroup={this.hideNewGroup} />}

                {<NewDocType showNewDocType={this.state.showCreateDocType} hideNewDocType={this.handleHideCreateDocType} />}
